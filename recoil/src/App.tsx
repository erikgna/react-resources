...
import AtomEffectsExperiment from './experiments/03-atom-effects/AtomEffectsExperiment'
import AsyncSelectorsExperiment from './experiments/04-async-selectors/AsyncSelectorsExperiment'
...
const TABS = [
  ...
  { id: '03', label: '3 · Atom Effects',   component: AtomEffectsExperiment },
  { id: '04', label: '4 · Async Selectors',component: AsyncSelectorsExperiment },
