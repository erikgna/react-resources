export default function CustomUtilityPlayground() {
    return (
      <div className="min-h-screen bg-slate-950 p-10 space-y-16 text-slate-200">
        ...
        {/* Test 1: Static Utility + Variants */}
        <section className="space-y-4">
          <h2 className="text-xl font-semibold border-l-4 border-neon-cyan pl-3">
            1. Static Utility & Variants
          </h2>
          <div className="space-y-6">
            <p className="text-glow text-4xl font-black">
              I ALWAYS GLOW
            </p>
            
            <p className="text-2xl font-bold hover:text-glow transition-all cursor-pointer">
              Hover me to glow (Variant Test)
            </p>
            
            <div className="hidden md:block text-glow text-sm italic">
              I only glow on medium screens and up (Breakpoint Test)
            </div>
          </div>
        </section>
  
        {/* Test 2: Complex CSS Utility */}
        <section className="space-y-4">
          <h2 className="text-xl font-semibold border-l-4 border-purple-500 pl-3">
            2. Complex CSS Logic
          </h2>
          <div className="relative h-48 w-64 bg-slate-800 rounded-lg overflow-hidden">
        ...
        {/* Test 3: Functional Utility with Arbitrary Values */}
        <section className="space-y-4">
          ...
          <div className="flex gap-8">
            <div className="h-32 w-48 overflow-y-scroll bg-slate-900 border border-slate-700 p-2 scrollbar-w-[4px]">
               <div className="h-64 bg-gradient-to-b from-yellow-500 to-transparent p-2">
