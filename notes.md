...
- For this KATA (ONLY)
- You are allowed to use Claude code.
- Each BOH team will need to generate 10 different prototypes (frontend + backend + BD)
...
You will need to build 2 AGENTS
A Debate Agent that will argue If the presented code is better or worse based on tech args
