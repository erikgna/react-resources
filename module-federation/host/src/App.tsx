...
const RemoteButton = lazy(() => import('remote_app/Button').catch(() => unavailable))
const RemoteCounter = lazy(() => import('remote_app/Counter').catch(() => unavailable))
...
function App() {
  ...
  return (
    <div>
      ...
      {/* Output from the remote utility function */}
      <p>{formatted}</p>
    </div>
  )
}
