...
import QueriesExperiment from './experiments/01-queries/QueriesExperiment'
import UserEventsExperiment from './experiments/02-user-events/UserEventsExperiment'
import AsyncExperiment from './experiments/03-async/AsyncExperiment'
import HooksExperiment from './experiments/04-hooks/HooksExperiment'
import ProvidersExperiment from './experiments/05-providers/ProvidersExperiment'
...
const TABS = [
  { id: '01', label: '1 · Queries',      component: QueriesExperiment },
  { id: '02', label: '2 · User Events',  component: UserEventsExperiment },
  { id: '03', label: '3 · Async',        component: AsyncExperiment },
  { id: '04', label: '4 · Hooks',        component: HooksExperiment },
  { id: '05', label: '5 · Providers',    component: ProvidersExperiment },
