module.exports = [
"[project]/.next-internal/server/app/api/purchase/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/services/purchase.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const registry = __TURBOPACK__imported__module__$5b$project$5d2f$domain$2f$registry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["InventoryRegistry"].getInstance();
function validatePurchaseOrder(order) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$domain$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateOrder"])(order, registry);
}
function executePurchase(order) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$domain$2f$facade$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ticketingFacade"].purchaseTickets(order);
}
function cancelTicket(ticketId) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$domain$2f$facade$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ticketingFacade"].cancelTicket(ticketId);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$purchase$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/purchase.service.ts [app-route] (ecmascript)");
;
;
async function POST(req) {
    ...
    if (!order.showId || !order.zoneType || !order.date || order.quantity == null) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Missing required fields: showId, zoneType, date, quantity'
        }, {
            status: 400
        });
    }
    const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$purchase$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validatePurchaseOrder"])(order);
    if (!validation.valid) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    try {
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$purchase$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executePurchase"])(order);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__95c76681._.js.map